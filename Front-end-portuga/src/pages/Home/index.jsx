    ...
    return (
        <main>
            ...
            <div className="cardMenu">
                <SectionCard title="Desafios Portuga!" photo={lupa} to='/ebook'/>


                <SectionCard className='Donation' title="Faça doações de livros!" photo={doação}>
                </SectionCard>

                <SectionCard title="Ebooks!" photo={livro}>
                </SectionCard>
